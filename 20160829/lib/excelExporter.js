...
(function () {
    ...
    var stringify = function (table, worksheet) {
		var str_template=template.replace("{worksheet}", worksheet)
        return encodeURIComponent(str_template.replace("{table}", table.innerHTML));
    };
    var downloadFile = function (table, fileName, worksheet) {
        if (!fileName) {
            var dt = new Date();
        ...
        var exportData = stringify(table, worksheet);
    ...
    this.fromTable = function (tableId, fileName, worksheet) {
        var table = document.getElementById(tableId);
        downloadFile(table, fileName, worksheet);
    };
    this.fromJson = function (data, selector, dataMap, fileName, worksheet) {
        ...
        pushKeys(keys, "");
        downloadFile(fillTable(exportData, keys, ""), fileName, worksheet);
    };
}).apply((excelExporter));